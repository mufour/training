...
$users = [
    [
        ...
        'email' => 'mickael.andrieu@exemple.com', // virgule manquante
        'age' => 34,
    ],
    [
...
$recipes = [
    ...
    [
        ...
        'is_enabled' => true, //faute de frappe sur enabled
    ],
];
...
function displayAuthor(string $authorEmail, array $users): string
    {
        ...
        return 'Author inconnu'; // rien n'avait été demandé de retourner
    }
